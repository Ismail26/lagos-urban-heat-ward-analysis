  ...
  <elevation symbology="Line" zscale="1" band="1" enabled="0" zoffset="0">
    ...
    <profileLineSymbol>
      <symbol frame_rate="10" alpha="1" clip_to_extent="1" name="" type="line" force_rhr="0" is_animated="0">
        ...
        <layer pass="0" class="SimpleLine" enabled="1" locked="0" id="{2aade38d-7ec0-44e5-9ef5-c9695974f094}">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol frame_rate="10" alpha="1" clip_to_extent="1" name="" type="fill" force_rhr="0" is_animated="0">
        ...
        <layer pass="0" class="SimpleFill" enabled="1" locked="0" id="{ab7e3444-1a1c-4ed3-bfa6-9c6ec6c5d003}">
          <Option type="Map">
  ...
  <pipe>
    ...
    <rasterrenderer nodataColor="" alphaBand="-1" opacity="1" band="1" type="paletted">
      ...
      <colorPalette>
        ...
        <paletteEntry color="#83e539" alpha="255" value="4" label="4 - Vegetation"/>
        <paletteEntry color="#1a8776" alpha="255" value="5" label="5 - Wetland"/>
        <paletteEntry color="#75f27b" alpha="255" value="6" label="6 - WetSoil"/>
      </colorPalette>
    </rasterrenderer>
